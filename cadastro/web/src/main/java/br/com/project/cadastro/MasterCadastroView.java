...
import br.com.project.foundation.view.MasterView;
 ...
 * @param <T>
 */
public abstract class MasterCadastroView<ID extends Serializable, T extends BaseObject> extends MasterView<ID, T> {
