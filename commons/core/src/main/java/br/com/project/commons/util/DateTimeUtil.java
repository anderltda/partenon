...
public class DateTimeUtil {
	...
	public static String DATE_MES_DESC_PATTERN = "MMMMM/yyyy";
	public static String DEFAULT_TIME_PATTERN = "HH:mm";
	public static String DEFAULT_DATETIME_PATTERN = DEFAULT_DATE_PATTERN + " " + DEFAULT_TIME_PATTERN;
	public static String DEFAULT_FULLDATETIME_PATTERN = DEFAULT_DATE_PATTERN + " " + DEFAULT_TIME_PATTERN + ":ss";
	public static String DEFAULT_TIME_MASK = "([0-1][0-9]|[2][0-3]):([0-5][0-9])";
	public static final long DIFF_IN_DAYS_FACTOR = 24 * 60 * 60 * 1000;
	...
	public static final boolean isValid24HourTime(String time) {
		if (StringUtil.isEmptyTrim(time))
			return false;
	...
	public static List<String> formatReturnDates(String value, String pattern, int meses) {
		List<String> datas = new ArrayList<String>();
		String dataFormat = "01/" + value;
		Date data = DateTimeUtil.getDate(dataFormat);

		datas.add(DateTimeUtil.formatDate(data, pattern));

		for (int i = 1; i <= meses; i++) {
			datas.add(DateTimeUtil.formatDate(DateTimeUtil.addMonths(data, -i), pattern));						
		}
	...
	public static String formatReturnDate(String value, String pattern) {
		String dataFormat = "01/" + value;
		Date data = DateTimeUtil.getDate(dataFormat);
		return DateTimeUtil.formatDate(DateTimeUtil.addMonths(data, -12), pattern);
	}
