...
public class ExtensoUtil {
	...
	private String Qualificadores[][] = { { "Centavo", "Centavos" }, { "", "" }, { "mil", "mil" }, { "milhão", "milhões" }, { "bilhão", "bilhões" }, { "trilhão", "trilhões" },
					{ "quatrilhão", "quatrilhões" }, { "quintilhão", "quintilhões" }, { "sextilhão", "sextilhões" }, { "septilhão", "septilhões" } };
	private String Numeros[][] = {
					{ "zero", "um", "dois", "três", "quatro", "cinco", "seis", "sete", "oito", "nove", "dez", "onze", "doze", "treze", "quatorze", "quinze", "desesseis", "desessete", "dezoito",
									"desenove" }, { "vinte", "trinta", "quarenta", "cinquenta", "sessenta", "setenta", "oitenta", "noventa" },
	...
	private boolean ehPrimeiroGrupoUm() {
		if (((Integer) nro.get(nro.size() - 1)).intValue() == 1) return true;
		return false;
	}
	...
	boolean ehGrupoZero(int ps) {
		if (ps <= 0 || ps >= nro.size()) return true;
	...
	public static void main(String[] args) {
		...
		ExtensoUtil teste = new ExtensoUtil(new BigDecimal(4560987.45));
		System.out.println("Numero  : " + (new DecimalFormat().format(Double.valueOf(4560987.45))));
