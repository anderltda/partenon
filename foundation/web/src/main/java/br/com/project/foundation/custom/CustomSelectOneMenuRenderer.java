...
public class CustomSelectOneMenuRenderer extends SelectOneMenuRenderer {
	...
	protected void encodeMarkup(FacesContext context, SelectOneMenu menu) throws IOException {
        ...
        boolean filterData = (Boolean) (menu.getAttributes().get("filter-data") != null ? menu.getAttributes().get("filter-data") : false);
        ...
        styleClass = styleClass == null ? SelectOneMenu.STYLE_CLASS + " form-control" : SelectOneMenu.STYLE_CLASS + " form-control " + styleClass;
		...
		HashMap<String, Boolean> closeDiv = ((HashMap<String, Boolean>) (menu.getAttributes().get("closeDiv") != null ? menu.getAttributes().get("closeDiv") : null));

		if(closeDiv != null && closeDiv.get(menu.getId())) {
			writer.endElement("div");   
		}
    }
