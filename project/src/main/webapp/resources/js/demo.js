...
$(function () {
  ...
  demo_settings.append(
		  ...
		  + "<div class='.checkbox'>"			
		  + "<label>"			
		  + "<a class=\"btn btn-block btn-primary\" data-toggle=\"modal\" data-target=\"#modal-email\"><i class=\"fa fa-envelope-o\"></i></a>"			
		  + "<a class=\"btn btn-block btn-primary\" data-toggle=\"modal\" data-target=\"#modal-help\"><i class=\"fa fa-question-circle\"></i></a>"			
		  + "</label>"			
		  + "</div>"			
		  + "</div>"		  
		  //Fixed layout
