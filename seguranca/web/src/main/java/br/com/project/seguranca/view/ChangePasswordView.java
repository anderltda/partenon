...
@ManagedBean
@SessionScoped
public class ChangePasswordView extends ProvidedSegurancaView<Long, Usuario> {

	private static final long serialVersionUID = 1L;

	@Override
	public String getEditPage() {
		return "/seguranca/formChangePassword.xhtml?faces-redirect=true";
	}
	...
	protected void executeSave() throws ServiceException {
		getService().trocarSenhaUsuario(bean);
	}
}
